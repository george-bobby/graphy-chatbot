...
def main():
    ...
    if 'neo4j_connected' not in st.session_state:
        ...
        neo4j_url = st.sidebar.text_input(
            "Neo4j URL:", value="neo4j+s://31f3573b.databases.neo4j.io")
        neo4j_username = st.sidebar.text_input(
            "Neo4j Username:", value="neo4j")
        neo4j_password = st.sidebar.text_input(
            "Neo4j Password:", type='password', value='vsrBFKBajDgj0RqoC1HVEKCvdkJsT25KccZ-c7A2Fz0')
    ...
    if graph is not None:
        ...
        uploaded_file = st.file_uploader(
            "Please select a PDF file.", type="pdf")
        ...
        if uploaded_file is not None and 'qa' not in st.session_state:
            with st.spinner("Processing the PDF..."):
                ...
                allowed_nodes = ["Patient", "Disease",
                                 "Medication", "Test", "Symptom", "Doctor"]
        ...
        st.warning(
            "Please connect to the Neo4j database before you can upload a PDF.")
